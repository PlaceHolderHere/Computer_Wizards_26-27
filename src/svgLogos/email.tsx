...
function EmailLogo({logoWidth, logoHeight}: logoProps){
    return(
        <svg width={`${logoWidth}px`} height={`${logoHeight}px`} viewBox="0 -4 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" >
