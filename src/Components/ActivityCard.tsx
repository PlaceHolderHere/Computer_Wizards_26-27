        ...
        <div className='activityCard'>
            ...
            <div className='activityDescription'>
                ...
                <div className='smallInfo'>
                    <div className="date">
                        <svg className="dateSVG" width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className='date-label'>{date ? date : "TBA"}</p>
                    </div>
                    <div className='location'>
                        <svg className="venueSVG" width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className='venue-label'>{venue ? venue : "TBA"}</p>
                    </div>
                </div>
